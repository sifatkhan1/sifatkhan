...
def login():
	...
	print("     {}|         {}<--D A R K  FB-->          {} |   ").format(CC,GG,CC)
        ...
        print("     {}<<{}===================================={}<<   ").format(CC,GG,CC)
	print("     {}    _________    ___                     ").format(BB)     
	print("     {}   /  ______/   /  /   {} ***************  ").format(BB,GL)
	print("     {}  /  /____/    /  /____{} *** {}H A C K {}***  ").format(BB,GL,CC,GL)
	print("     {} /  /         /  ___  /{} ***************  ").format(BB,GL)
	print("     {}/__/         /_______/                   ").format(BB)
	print("  ")
        print 40 * '\x1b[1;97m\xe2\x95\x90'
        print '\x1b[1;91m[\xe2\x98\x86] \x1b[1;92mLOGIN AKUN FACEBOOK loe DULU \x1b[1;91m[\xe2\x98\x86]'
...
def menu():
    ...
    print '\x1b[1;32;42m1. Informasi Pengguna'
    print '\x1b[1;32;42m2. Hack Akun Facebook'
    print '\x1b[1;32;42m3. Bot               '
    print '\x1b[1;36;46m4. Lainnya....       '
    print '\x1b[1;31;41m5. LogOut            '
    print '\x1b[1;31;41m0. Keluar            '
    print
    pilih()
...
def menu_hack():
    ...
    print '\x1b[1;37;40m3. Super Multi Bruteforce Facebook (XBAL MEONK)'
...
def super():
    ...
    print '\x1b[1;37;40m2. Crack dari anggota Grup'
    print '\x1b[1;31;40m0. Kembali'
    print
    pilih_super()
...
def pilih_super():
    ...
    p = ThreadPool(30)
    p.map(main, id)
    print '\n\x1b[1;91m[+] \x1b[1;97mSelesai Cuk.(cuma bisa ambil segini).'
    raw_input('\n\x1b[1;91m[ \x1b[1;97mKembali \x1b[1;91m]')
    super()
